...
<footer id="footer">
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            <a href="index.html"><img src="images/logo-zozo.svg" alt="" class="img-fluid logo-footer"></a>
          ...
          <div class="col-md-3">
            <div class="useful-link">
              ...
              <div class="use-links">
                ...
                <li><a href="admin/dashboard.php"><i class="fa-solid fa-angles-right"></i>Admin Panel</a></li>
